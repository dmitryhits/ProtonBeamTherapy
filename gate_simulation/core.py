...
__all__ = ['Ek', 'create_sensor', 'create_phantom_layer', 'create_beam', 'create_start_beams', 'create_macro_file',
           'run_macro']
...
def create_sensor(n=0, x_length=20, z_length=20, thickness=0.1, x_loc=0, y_loc=0, z_loc=0,
                  system='scanner', material='Silicon', macro_folder='mac'):
    ...
    with open(f'{macro_folder}/sensor{n}.mac', 'w') as file:
        file.write(lines)



# Cell
def create_phantom_layer(n=0, x_length=20, z_length=20, thickness=1, x_loc=0, y_loc=0, z_loc=0, material='Water'):
    '''
    This writes a GATE macro for creating a phantom box
    ...
    """
    with open(f'mac/phantom{n}.mac', 'w') as file:
            file.write(lines)

# Cell
def create_beam(energy=250, sigma_energy=1.0, position={'x':0, 'y':250, 'z':0}):
    lines = f'''
    #=====================================================
    # BEAMS
    #=====================================================
    ...
    '''
    with open(f'mac/beam{energy}.mac', 'w') as f:
        f.write(lines)
...
def create_start_beams(n_primaries=10000):
    ...
    """
    with open(f'mac/start_beam{n_primaries}.mac', 'w') as f:
        f.write(lines)

# Cell
def create_macro_file(macro_dict, macro_folder='mac'):
    lines = f"""
    #=====================================================
    # GEOMETRY
    #=====================================================
    ...
    with open(f'{macro_folder}/main_macro{timestamp}.mac', 'w') as f:
        f.write()
