# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/00_macro_tools.ipynb (unless otherwise specified).
...
# Cell
def create_all(n_phantom_layers = 20, phantom_layer_thickness = 1, phantom_material = 'Water', distance_to_beam = 10,
